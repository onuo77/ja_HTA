...
public class EmployeeDao {
	...
	public void insertEmployee(Employee employee) throws SQLException{
		String sql = "insert into employees "
					...
					+ "salary, commission_pct, job_id, manager_id, department_id) "
					+ "values "
		...
		pstmt.setDouble(6, employee.getCommissionPct());
	...
	public EmployeeDto getEmployeeDtoById(int empId) throws SQLException{
		...
		if(rs.next()) {
			...
			dto.setManagerId(rs.getInt("mgr_id"));
			dto.setManagerFullName(rs.getString("mgr_fullname"));
