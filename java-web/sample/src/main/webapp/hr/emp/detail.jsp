			...
			<div class="col-12">
				...
				<table class="table table-bordered">
					...
					<tr>
						...
						<th>커미션</th><td><%=dto.getCommissionPct() == 0 ? "없음" : dto.getCommissionPct() %></td>						
					</tr>
					<tr>
						<th>소속부서</th><td><%=dto.getDepartmentId() == 0 ? "없음" : dto.getDepartmentId() %></td>
						<th>소속부서명</th><td><%=dto.getDepartmentName() == null ? "없음" : dto.getDepartmentName() %></td>
					</tr>
				</table>
			</div>
