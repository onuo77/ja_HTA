	...
	<div class="row">
		<div class="col-6 offset-3">
			<div class="row mt-3" id="box-images">
				<div class="col-4 p-2">
					<img alt="사진" src="images/1.jpg" class="img-thumbnail">
				</div>
				<div class="col-4 p-2">
					<img alt="사진" src="images/1.jpg" class="img-thumbnail">
				</div>
...
<script type="text/javascript">
	...
	//화면이 스크롤될 때(onscroll 이벤트가 발생될 때)마다 실행되는 이벤트 핸들러 함수를 jQuery에 전달
	...
	function createImagebox(imageName){
		var content = '<div class="col-4 p-2">'
			content += '<img src="' + imageName + '"images/1.jpg" class="img-thumbnail" alt="사진" />'
			content += '</div>';
