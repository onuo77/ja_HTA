...
<div class="container">
	...
	<ul id="list-site-mall">
		<li><a href="https://www.gmarket.com">지마켓</a></li>
...
<script type="text/javascript">
	//href의 속성값이 https://www.google.com인 링크를 선택하기
	...
	//체크박스 전부 선택하기
	$('input[type=checkbox]').prop('checked', true); //단어나 단어사이에 공백이나 특수문자 없으면 ''없이 사용가능
	$('input[name=skill]').prop('checked', true);
	$("input[id^='search-opt-skill']").prop('checked', true); //단어와 단어사이에 특수문자나 공백이 있으면 '' 사용
