...
<script type="text/javascript">
	...
	//두번째 div에서 h3 다음에 있는 a들을(링크2, 링크3) 선택해서 글자크기를 변경하기
	//$("#box-2 > a").css('font-size', '50px');
	$("#box-2 h3 ~ a").css('font-size', '50px');
	//두번째 div에서 리스트 링크들을 선택해서 글자크기를 변경하기
	$("#box-2 ul a").css('font-size', '8px');
	//첫번째 div의 리스트 링크 중에서 첫번째 리스트 링크1만 선택해서 배경색을 초록색으로 변경하기
	$("#box-1 ul a:first").css("background-color", "lightgreen");
	//첫번째 div의 맨마지막번째 리스트링크4와 두번째 div의 맨마지막번째 리스트링크4를 선택해서 배경색을 회색으로 변경하기
	$("#box-1 ul a:last, #box-2 ul a:last").css("background-color", "lightgray");
