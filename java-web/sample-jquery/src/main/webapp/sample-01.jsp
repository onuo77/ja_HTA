...
<script type="text/javascript">
	...
	/* 
		...
		- jQuery집합객체에는 검색된 모든 p엘리먼트를 조작하거나, 스타일을 변경할 수 있는 다양한 메소드도 가지고 있다.
		...
		//jQuery집합객체1과 jQuery집합객체2는 같은 객체다.
		//대부분의 jQuery집합객체의 메소드들은 메소드를 실행하고 나면, jQuery집합객체를 다시 반환한다.

		var jQuery집합객체1 = $("p");
		var jQuery집합객체2 = jQuery집합객체1.메소드명();	ex)jQuery집합객체1.css('color', 'red');
